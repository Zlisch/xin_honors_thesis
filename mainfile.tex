...
\input{holtexbasic.sty}

\begin{document}

\pagenumbering{roman}
\input{out_tex/0-titlepage}                               % define your title page
\input{out_tex/0-declaration}                             % includes the declaration of authorship
\input{out_tex/0-acknowledgements}                        % optional acknowledgements
\input{out_tex/0-abstract}                                % your abstract
...
\input{out_tex/1-introduction}                  % introduction
\input{out_tex/2-background}                    % background/framework
\input{out_tex/3-relatedWork}                   % related work
\input{out_tex/4-richerLang}                     % about thesis structure and compilation
\input{out_tex/5-strongNormalisation}                 % general writing advice
\input{out_tex/6-enrichedChor}                   % latex advice

\input{out_tex/7-conclusion}                    % conclusion
\input{out_tex/8-test}
\appendix
