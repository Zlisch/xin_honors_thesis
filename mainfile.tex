...
\documentclass[a4paper,twoside,cleardoublepage=plain,bibliography=totoc]{book}
...
\fi]}
\newcommand{\richerlang}{\textsf{Sprinkles}}
...
\usepackage{amssymb,amsthm}                  % standard math packages; often used
...
\appendix
\input{out_tex/z-appendix-1}                    % appendix 1
