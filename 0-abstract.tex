...
is then projected into process models for each endpoint,
...
when local computations are considered. Our proofs show that the strong normalisation
property of \richerlang{} implies \emph{progress} for the enriched Kalas, and that
the combination of type soundness and strong normalisation of of \richerlang{} implies
type preservation for non-recursive, synchronous transitions in the enriched Kalas.
